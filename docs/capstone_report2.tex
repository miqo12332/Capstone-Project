...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{CoreUI\footnote{CoreUI. (n.d.). \textit{CoreUI React admin template and UI components}. https://coreui.io/react}}: Provides component-based layouts, navigation structures,
  dashboards, and visualization patterns used across the application.
\end{itemize}

\subsubsection{Backend}
\begin{itemize}[leftmargin=*]
  \item \textbf{Node.js\footnote{Node.js Foundation. (n.d.). \textit{Node.js documentation}. https://nodejs.org/en/docs} with Express}: Supplies the runtime and HTTP framework used for
...
\begin{itemize}[leftmargin=*]
  \item \textbf{PostgreSQL\footnote{PostgreSQL Global Development Group. (n.d.). \textit{Why PostgreSQL? Advantages and features}. PostgreSQL Documentation. https://www.postgresql.org/about/}}: Stores structured data for profiles, habits, tasks,
...
\begin{itemize}[leftmargin=*]
  \item \textbf{LangChain with Large Language Models (Anthropic)\footnote{IBM. (n.d.). \textit{What is Claude AI and why it matters}. IBM Think. https://www.ibm.com/think/topics/ai}}: Powers AI-assisted
